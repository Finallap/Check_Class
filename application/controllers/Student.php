<?php
	...
	class Student extends CI_Controller
	{
		...
		public function data_entry()
		{
			...
			$this->load->view('student/header',$header_data);
			$this->load->view('student/student_check_class_classroom_select');
			$this->load->view('template/footer');
			$this->load->view('student/two_select_js',$data);
		}
		...
		public function data_entry_middleware()
		{
			...
			$teaching_building=$this->input->post('teaching_building');
			$classroom_number=$this->input->post('classroom');
			$classroom=$teaching_building.'-'.$classroom_number;

			$header_data['account']=$this->user_name;

			$this->get_course_now($classroom);
			...
			$this->load->view('student/header',$header_data);
			$this->load->view('student/student_check_class_information_record_page',$data);
			$this->load->view('template/footer');
		}

		protected function get_course_now($classroom)
		{
		...
		public function data_entry_action()
		{
			...
			{
				$data['alert_information']="现在这教室并没有课，你在干嘛呢(｡˘•ε•˘｡)";
